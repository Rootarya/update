-- ============================================================
-- FIX: Drop view lama dulu, lalu buat ulang
-- Jalankan di Supabase → SQL Editor
-- ============================================================

-- Step 1: Drop view lama
DROP VIEW IF EXISTS admin_orders_view CASCADE;
DROP VIEW IF EXISTS admin_stats CASCADE;

-- Step 2: Tambah kolom ke orders (skip kalau sudah ada)
ALTER TABLE orders
...
-- Step 4: Buat ulang admin_orders_view
...
SELECT 'Berhasil! Semua tabel dan view sudah dibuat ulang.' AS status;
